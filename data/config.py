...
Data_Intel_RealSense  = dataset_base.copy({
    'name': 'Ahmet Nasri - Data_Intel_RealSense',

    # Training images and annotations
    'train_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/data/images/1',
    'train_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/data/labels/annotation.json',

    # Validation images and annotations.
    'valid_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/val/images/1',
    'valid_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/val/labels/annotation.json',

    # Whether or not to load GT. If this is False, eval.py quantitative evaluation won't work.
    'has_gt': True,

    # A list of names for each of you classes.
    'class_names': ('Intel RealSense'),
...
Data_object  = dataset_base.copy({
    'name': 'Ahmet Nasri - Data_object',

    # Training images and annotations
    'train_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/Technical/codes/data set/train/images',
    'train_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/Technical/codes/data set/train/annotation.json',

    # Validation images and annotations.
    'valid_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/Technical/codes/data set/val/images',
    'valid_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/Technical/codes/data set/val/annotation.json',
...
cig_butts_dataset  = dataset_base.copy({
    ...
    # Training images and annotations
    'train_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/cig_butts/train/images',
    'train_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/cig_butts/train/coco_annotations.json',

    # Validation images and annotations.
    'valid_images': 'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/cig_butts/val/images',
    'valid_info':   'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/cig_butts/val/coco_annotations.json',
...
yolact_resnet50_Intel_RealSense = yolact_resnet50_config.copy({
    'name': 'yolact_resnet50_Intel_RealSense',
    # Dataset stuff
    'dataset': Data_Intel_RealSense,
    'num_classes': len(Data_Intel_RealSense.class_names) + 1,

    # Image Size
    'max_size': 512 ,
})

yolact_resnet50_objekt = yolact_resnet50_config.copy({
    'name': 'yolact_plus_resnet50_objekt',
    # Dataset stuff
    'dataset': Data_object,
    'num_classes': len(Data_object.class_names) + 1,

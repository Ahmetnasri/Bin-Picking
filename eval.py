...
def parse_args(argv=None):
    ...
    parser.add_argument('--camera', default=False, type=str,
                        help='A path to an image to use for display.')                   

    global args
    args = parser.parse_args(argv)
    args.video='0'
    args.trained_model= 'C:/Users/ahmet/Desktop/Bin Picking Project/yolact/yolact-master/weights/yolact_resnet50_Intel_RealSense_283_3974_interrupt.pth'
    #args.trained_model='C:/Users/ahmet/Desktop/yolact/yolact_resnet50_Intel_RealSense_283_3974_interrupt.pth'
    #args.trained_model='C:/Users/ahmet/Desktop/yolact/yolact_plus_resnet50_objekt_386_772_interrupt.pth'
    args.config = 'yolact_resnet50_Intel_RealSense'
    #args.trained_model='C:/Users/ahmet/Desktop/yolact/yolact_plus_resnet50_objekt_386_772_interrupt.pth'
    #args.config = 'yolact_resnet50_objekt'
...
def prep_display(dets_out, img, h, w, undo_transform=True, class_color=False, mask_alpha=0.45, fps_str=''):
    ...
    with timer.env('Postprocess'):
        ...
        '''ah, ma , na, va = postprocess(dets_out, w, h, visualize_lincomb = args.display_lincomb,
    ...
    if args.display_masks and cfg.eval_mask_branch and num_dets_to_consider > 0:
        for j in reversed(range(num_dets_to_consider)):
            ...
            y = int(y1 + (y2 - y1)/2)
        #print(x,' ',y)
        #img_numpy = cv2.circle(img_numpy,(x,y),10, (255,255,255), 5)
        #print(x,y)
        ...
        #print(type(masks_color))

        '''# This is 1 everywhere except for 1-mask_alpha where the mask is
        inv_alph_masks = masks #* (-mask_alpha) + 1
        #inv_alph_masks = masks1
        #inv_alph_masks = mask_alpha
        #inv_alph_masks = masks * (-mask_alpha) + 1
        ...
        #img_gpu1 = img_gpu * inv_alph_masks.prod(dim=0) + masks_color_summand
    ...
    img_numpy = get3d(img_numpy,x,y)
    
    #
    #img_numpy = get3d(img_numpy)
...
def evalvideo(net:Yolact, path:str, out_path:str=None):
    ...
    if is_webcam:
        #path = 'C:/Users/ahmet/Desktop/Bin Picking Project/Baraa/New_Final_Version/newest_data/00.bag'
        #path = 'C:/Users/ahmet/Desktop/Bin Picking Project/Open3d/Final_Test/Test_Ultimat.bag'
        path = 'C:/Users/ahmet/Desktop/Bin Picking Project/Open3d/Final_Test/Test_X_Rotation.bag' 
    #try:
        ...
        vid = pipeline.wait_for_frames()
        #frames = align.process(frames)


        #depth_frame = vid.get_depth_frame()
        color_frame = vid.get_color_frame()

        color_frame = np.asanyarray(color_frame.get_data())
        #color_frame = cv2.cvtColor(color_frame, cv2.COLOR_BGR2GRAY)
        #cv2.imshow('a',color_frame)
        #cv2.waitKey(0)
    #finally:
        #pipeline.stop()
        #return save_path
    ...
    def get_next_frame(vid):
        ...
        for idx in range(args.video_multiframe):
            #print(idx)
            #print(range(args.video_multiframe))
            vid = pipeline.wait_for_frames()
            frame = vid.get_color_frame()
            ...
            while running:
                ...
                if not frame_buffer.empty():
                    ...
                    if out_path is None:
                        ...
                        cv2.imshow('aa', frame_buffer.get())
                    else:
                ...
                if out_path is None and cv2.waitKey(1) == ord('a'):
                    # Press a to close
                    running = False
...
def evaluate(net:Yolact, dataset, train_mode=False):
    ...
    if args.image is not None:
        ...
        if ',' in args.video:
            ...
            sonuc = evalvideo(net, args.video)
            return sonuc
        return
